...
sig_dict <- list("No Ablation, Light" = "A", "Ablated, Light" = "B","No Ablation, Dark" = "A", "Ablated, Dark" = "B")
perp_angle_df$sig_letters <- unlist(sig_dict[interaction(perp_angle_df$Ablation, perp_angle_df$Darkness, sep =", ")])
...
heading_PS_graph_close <- ggplot(perp_angle_df %>% filter(Dist_Cat == "Close"),
  ...
  scale_y_continuous(breaks = seq(-180,180, 60), limits = c(-180,300))+
  geom_text(aes(label = sig_letters, y = 300), color = "black", size = sig_text_size) +
...
sig_dict <- list("No Ablation, Light" = "A", "Ablated, Light" = "A","No Ablation, Dark" = "B", "Ablated, Dark" = "B")
perp_angle_df$sig_letters <- unlist(sig_dict[interaction(perp_angle_df$Ablation, perp_angle_df$Darkness, sep =", ")])
...
ggsave("Paper Figures/Figure 3.png", heading_PS_mega_plot, width = 14, height = 7)
...
sig_dict <- list("No Ablation, Light" = "A", "Ablated, Light" = "A","No Ablation, Dark" = "B", "Ablated, Dark" = "B")
school_data$sig_letters <- unlist(sig_dict[interaction(school_data$Ablation, school_data$Darkness, sep =", ")])
...
nnd_still <- ggplot(school_data %>% filter(Flow == "Still Water"),
  ...
  theme(legend.position = "none") +
  #ylim(0,2.5)+
  geom_text(aes(label = sig_letters, y = 4), color = "black", size = sig_text_size) +
  theme(axis.text.x = element_text(size = text_size),
        axis.text.y = element_text(size = text_size),
        axis.title.y = element_text(size = text_size))+
  scale_x_discrete(labels=function(x){sub(",\\s", "\n", x)})

sig_dict <- list("No Ablation, Light" = "", "Ablated, Light" = "","No Ablation, Dark" = "", "Ablated, Dark" = "")
school_data$sig_letters <- unlist(sig_dict[interaction(school_data$Ablation, school_data$Darkness, sep =", ")])
...
polar_still <- ggplot(school_data %>% filter(Flow == "Still Water"),
  ...
  geom_text(aes(label = sig_letters, y = 1.1), color = "black", size = sig_text_size) +
  theme(axis.text.x = element_text(size = text_size),
        axis.text.y = element_text(size = text_size),
        axis.title.y = element_text(size = text_size))+
  scale_x_discrete(labels=function(x){sub(",\\s", "\n", x)})

sig_dict <- list("No Ablation, Light" = "A", "Ablated, Light" = "A","No Ablation, Dark" = "A", "Ablated, Dark" = "B")
school_data$sig_letters <- unlist(sig_dict[interaction(school_data$Ablation, school_data$Darkness, sep =", ")])
...
speed_still <- ggplot(school_data %>% filter(Flow == "Still Water"),
  ...
  theme(legend.position = "none") +
  ylim(0,6)+
  geom_text(aes(label = sig_letters, y = 5.5), color = "black", size = sig_text_size) +
  theme(axis.text.x = element_text(size = text_size),
        axis.text.y = element_text(size = text_size),
        axis.title.y = element_text(size = text_size))+
  scale_x_discrete(labels=function(x){sub(",\\s", "\n", x)})
...
sig_dict <- list("No Ablation, Light" = "A", "Ablated, Light" = "A","No Ablation, Dark" = "B", "Ablated, Dark" = "B")
group_sum_data$sig_letters <- unlist(sig_dict[interaction(group_sum_data$Ablation, group_sum_data$Darkness, sep =", ")])
...
ggsave("Paper Figures/Figure 2.png", school_stats_mega_plot, width = 12, height = 17)
```
