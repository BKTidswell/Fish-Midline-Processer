...
heading_PS_model_close <- lmer(Fish1_Yaw_Heading_PS ~ 0 + sin(Angle) + sin(Angle):Ablation + sin(Angle):Darkness + sin(Angle):Ablation:Darkness + (1|Date), 
                   data = fish_data_nn_normal_close %>% filter(Flow == "Still Water")) 
Anova(heading_PS_model_close)

heading_PS_model_far <- lmer(Fish1_Yaw_Heading_PS ~ 0 + sin(Angle) + sin(Angle):Ablation + sin(Angle):Darkness + sin(Angle):Ablation:Darkness + (1|Date), 
