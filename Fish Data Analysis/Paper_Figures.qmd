...
single_plot <- ggplot(single_perp_angle_graphing, aes(x = rad2deg(Fish1_Yaw_Heading_PS), fill = Label))+
  geom_histogram(aes(y=0.5*..density..),binwidth=45,position='identity', alpha = 0.5)+
  theme_classic()+
