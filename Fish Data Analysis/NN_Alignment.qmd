...
Okay so I think fish in darkness are paying attention to less fish Only responding to turns when one or two other fish do, and more apart in time.

Look at delays in fish turning NN Heading might obscure some things as they pair up again soon after
...
fish_comp_data_combo %>% group_by(Flow, Ablation, Darkness) %>% summarise(n = n())
