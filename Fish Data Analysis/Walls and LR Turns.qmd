...
turning_glm_F0LNDN_B <- glm(turn_bool ~ 1,
                         ...
                         family = binomial)
turning_glm_F0LNDN_W <- glm(turn_bool ~ Left_Wall_Dist,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, No Ablation, Light"),
                         family = binomial)
turning_glm_F0LNDN_F <- glm(turn_bool ~ Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, No Ablation, Light"),
                         family = binomial)
turning_glm_F0LNDN_WF <- glm(turn_bool ~ Left_Wall_Dist*Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, No Ablation, Light"),
                         family = binomial)
...
turning_glm_F0LYDN_B <- glm(turn_bool ~1,
                         ...
                         family = binomial)
turning_glm_F0LYDN_W <- glm(turn_bool ~ Left_Wall_Dist,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, Ablated, Light"),
                         family = binomial)
turning_glm_F0LYDN_F <- glm(turn_bool ~ Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, Ablated, Light"),
                         family = binomial)
turning_glm_F0LYDN_WF <- glm(turn_bool ~ Left_Wall_Dist*Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, Ablated, Light"),
                         family = binomial)
...
turning_glm_F0LNDY_B <- glm(turn_bool ~ 1,
                         ...
                         family = binomial)
turning_glm_F0LNDY_W <- glm(turn_bool ~ Left_Wall_Dist,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, No Ablation, Dark"),
                         family = binomial)
turning_glm_F0LNDY_F <- glm(turn_bool ~ Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, No Ablation, Dark"),
                         family = binomial)
turning_glm_F0LNDY_WF <- glm(turn_bool ~ Left_Wall_Dist*Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, No Ablation, Dark"),
                         family = binomial)
...
turning_glm_F0LYDY_B <- glm(turn_bool ~ 1,
                         ...
                         family = binomial)
turning_glm_F0LYDY_W <- glm(turn_bool ~ Left_Wall_Dist,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, Ablated, Dark"),
                         family = binomial)
turning_glm_F0LYDY_F <- glm(turn_bool ~ Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, Ablated, Dark"),
                         family = binomial)
turning_glm_F0LYDY_WF <- glm(turn_bool ~ Left_Wall_Dist*Fish_Num_Ratio,
                         data = eight_fish_turning_data %>% filter(Flow_Ablation_Darkness == "Still Water, Ablated, Dark"),
                         family = binomial)
