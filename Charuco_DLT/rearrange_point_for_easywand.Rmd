...
```{r}
detections <- read_csv("/Users/Ben/Desktop/Fish-Midline-Processer/Charuco_DLT/charuco_boards/2023_06_29/boards.csv") |> 
  select(-`...1`)
```

Fill in the directory that has the video files and the names of each video.
```{r}
videodir <- '//Users/Ben/Desktop/Fish-Midline-Processer/Charuco_DLT/charuco_boards/2023_06_29'
camfiles <- c('checkerboard_V1.mp4','checkerboard_V2.mp4')
...
```{r}
write_csv(ptsforeasywand, "//Users/Ben/Desktop/Fish-Midline-Processer/Charuco_DLT/charuco_boards/2023_06_29/2023_06_29_calibrationcharuco_xypts.csv")
```
