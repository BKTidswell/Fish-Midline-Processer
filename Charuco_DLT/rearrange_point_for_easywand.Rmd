...
```{r}
detections <- read_csv("/Users/Ben/Desktop/Fish-Midline-Processer/Charuco_DLT/charuco_boards/2023_04_06/boards.csv") |> 
  select(-`...1`)
```

Fill in the directory that has the video files and the names of each video.
```{r}
videodir <- '//Users/Ben/Desktop/Fish-Midline-Processer/Charuco_DLT/charuco_boards/2023_04_06'
...
```{r}
write_csv(ptsforeasywand, "//Users/Ben/Desktop/Fish-Midline-Processer/Charuco_DLT/charuco_boards/2023_04_06/2023_04_06_calibrationcharuco_xypts.csv")
```
